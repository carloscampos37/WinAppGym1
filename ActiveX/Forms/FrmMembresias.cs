...
namespace AppGym.Forms
{
    public partial class FrmMembresias : Form
    {
        ...
        {
            ctr_AyuPeriodos.CadenaCone = FuncNet.VGCnxSql;
        ...
        private void BntModificar_Click(object sender, EventArgs e)
        {
            ...
            using (Model1 bd = new Model1())
            {
                ...
                DtpInicio.Value = Convert.ToDateTime(FuncNet.EsNulo(Resultado.InicioVigencia, "01-01-1900"));
                Dtptermino.Value = Convert.ToDateTime(FuncNet.EsNulo(Resultado.TerminoVigencia, "01-01-1900"));
            ...
            FuncNet.ActivaTab(2, 2, ref tabControl1);
        ...
        private void BntGrabar_Click(object sender, EventArgs e)
        {
            ...
            FuncNet.ActivaTab(1, 2, ref tabControl1);
